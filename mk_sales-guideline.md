...
#### 4.1.1 WebBPとしての狙い  
	1. サービスエンジニア一人あたりの売り上げを引き上げる  
	   個別提案・要件定義・設計・構築等の導入稼働、及び故障エスカレーション・システム変更相談(特に、  
	   要件の不明瞭な相談)・運用報告等のサービスエンジニアに係るお客さま占有稼働を削減し、より多く
	   のお客さまへの対応が出来るようになることを期待しています。  
	2. 運用の条件の見直しや業務の自動化により、変更作業のリードタイム等、従来の運用における制約を可能な限り少なくし、  
	   お客さま情報システムの可用性を
