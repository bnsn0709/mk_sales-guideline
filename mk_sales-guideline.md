...
#### 4.1.1 WebBPとしての狙い  
	1. サービスエンジニア一人あたりの売り上げを引き上げる  
	   個別提案・要件定義・設計・構築等の導入稼働、及び故障エスカレーション・システム変更相談(特に、要件の不明瞭な相談)  
	   ・運用報告等のサービスエンジニアに係るお客さま占有稼働を削減し、より多くのお客さまへの対応が出来るようになること
	   を期待しています。  
	2. 運用サービスとしての利便性を向上させる  
	   サービスをよりお客さま視点で見直し、併せてバックヤードの業務を新たなツールの導入や自動化により最適化することで、  
	   サービス内容の充実とリードタイムの削減を目指します。
   
#### 4.1.2 お客さまメリットとしての狙い  
	1. DX(デジタルトランスフォーメーション)の実現  
	サービスエンジニア一人あたりの売り上げを引き上げる  



DX需要の喚起と取り込み  
従来のSIで主流であったカスタマイズや個別仕様を前提とした高価な情報システムから脱却し、基盤や運用の設計を共通化したデジタル化の容易な情報システムを前提としたDXの実現で得られる半歩先のメリットを訴求しつつ、構築・運用双方のコスト低減を目先の具体的なメリットとして、お客さま情報システムの刷新や新たな情報システムの導入需要を喚起します。  
...
『システム構成パターン』は、機能性(必要な機能と配置)、冗長性、キャパシティ、拡張性などを考慮したお客さま情報システムの設計・構築・試験における全ての作業が定義されたシナリオで、以下の内容で構成されます。  
