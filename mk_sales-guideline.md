...
#### 4.1.2 お客さまメリットとしての狙い  
	1. 情報システムの構築と運用のコストを引き下げる
	   従来のSIで主流であったカスタマイズや個別仕様を前提とした高価な情報システムから脱却し、基盤や運用の設計を共通化した
	   デジタル化の容易な情報システム  
	2. DX(デジタルトランスフォーメーション)の実現  



DX需要の喚起と取り込み  
を前提としたDXの実現で得られる半歩先のメリットを訴求しつつ、構築・運用双方のコスト低減を目先の具体的なメリットとして、お客さま情報システムの刷新や新たな情報システムの導入需要を喚起します。  
