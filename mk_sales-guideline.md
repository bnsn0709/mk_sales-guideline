...
```
　私たちは、共通化された設計や運用によってお客さまの情報システムの自由度が拡大することを信じています。ただ、個別の設計、個別の
...
```  
技術の進化やトレンドの変化によってお客さまのニーズも変わっていきます。私たちは、それらとともに、このサービスをより良いものに変え続けます。それは機能の改善であり、追加であり、最適化です。
