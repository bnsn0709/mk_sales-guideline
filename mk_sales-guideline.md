...
#### 4.1.1 WebBPとしての狙い  
	1. 提案、要件定義、設計、構築の導入稼働、故障・問い合わせのエスカレーション、システム変更相談(特に、要件の不明瞭な  
	   相談)、運用報告等のサービスエンジニアに係るお客さま占有稼働を削減し、サービスエンジニア一人あたりの売り上げを引き上げること  
	   を期待しています。  
	2. 運用条件の見直しや業務の自動化により、変更作業のリードタイム等、従来の運用における制約を可能な限り少なくし、お客さま  
	   情報システムの可用性を
