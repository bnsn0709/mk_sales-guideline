...
* お客さまの情報システムの構成は、あらかじめ用意された『システム構成パターン』から選んでいただきます。
* お客さま個別のご要望に基づいて、システム構成パターンをカスタマイズすることも可能です。
* システム構成パターンをカスタマイズする場合、その範囲の大きさや技術的な制約に依ってWebBP-mkのメリットを提供できない場合があります。
* “系切り替わり”など事前に合意された設計に基づく動作による一時的なサービス断は、サービス障害として扱いません。お客さまへの通知、報告等も行いません。 
* お客さまの情報システムで利用されるオペレーションシステム(OS)、ミドルウェア、パッケージソフトウェアのライフサイクルは、それぞれの提供元ベンダーから提示されるライフサイクル情報に従います。  
<br>  

> Ansibleと言わない。(Playbookと言わず、Template(｡｡｡とか何か格好いい言い回しは無いかな？)という。)セキュリティとビジネスモデルを守るため、仕組みは公表しない。  

> (次の言い回しはくどいかな。。。)設計・構築のリードタイムとコスト、運用における変更業務等のリードタイムとコスト、それらの大幅な低減を実現させるために、
<br>  
<br>  
...
『システム構成パターン』は、機能性(必要な機能と配置)、冗長性、キャパシティ、拡張性などを考慮したお客さま情報システムの設計・構築・試験における全ての作業が定義されたシナリオです。機能、性能、冗長などの観点から多くのバリエーションをご用意します。  
...
|-------------------------------	|--------------------------------------	|--------------------------------------	|----	|---	|
| <span style="font-size:80%">**お客さま情報システム<br>構築･運用**</span>  	| Logical Network 	| <td align="center;">◎</td> 	| <div style="text-align: center;">◎</div> 	| <div style="text-align: center;">◎</div> 	|
...
|  	| PackageSoftware(※1) 	| <div style="text-align: center;">－</div> 	| <div style="text-align: center;">◎</div> 	| <div style="text-align: center;">◎</div> 	|
|  	| <font color="Red"> Software開発(※2) </font>	 	| <div style="text-align: center;">－</div> 	| <div style="text-align: center;">－</div> 	| <div style="text-align: center;">◎</div> 	|
| <span style="font-size:80%">**お客さまサービス<br>運用代行**(※3)</span> |  	| <div style="text-align: center;">－</div> 	| <div style="text-align: center;">－</div> 	| <div style="text-align: center;">◯</div> 	|  
