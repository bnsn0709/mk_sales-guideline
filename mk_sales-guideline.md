...
<span style="color: red; ">WebBP-mkの狙いは、お客さまが情報システムを導入・刷新するにあたり、構築コスト、及び運用コストが低減することをメリットとして、高価なカスタマイズの世界から脱却し、設計を共通化したデジタル化の容易な情報システムの導入へお客さまを誘導していくことにあります。  
